  ...
  const planos = [
    {
      ...
      benefits: [
        ...
        "Até 300 a 1000 alunos cadastrados",
      ],
    },
    {
      title: "Plano Pro",
      ...
      benefits: [
        ...
        "Até 1000 a 2000 alunos cadastrados",
      ],
    },
    {
      title: "Plano Elite",
      ...
      benefits: [
        ...
        "Liberação total ao Dashboard",
        "Negociar quanitdade de alunos cadastrados",
      ],
    },
  ];
  ...
  return (
    ...
    >
      <div className="container mx-auto items-center px-5">
        <header className="lg:text-center mb-12 mt-28 lg:mt-16">
              ...
              >
                ...
                <div className="mb-5 mt-8">
                  ...
                  <p className="text-sm font-bold mb-3 text-gray-400">
                    Total de R$ {(plano.price * 12).toFixed(2)}/ano
                  </p>
