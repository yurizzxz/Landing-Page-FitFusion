export default function FAQ() {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Você pode acessar o controle de treino diretamente pela plataforma FitPilot, sem a necessidade de utilizar fichas de papel, otimizando o gerenciamento dos exercícios dos seus alunos.",
    },
    {
