  ...
  return (
    ...
    >
      <section className="container pt-20 pb-28 flex flex-col lg:flex-row-reverse items-center justify-between mx-auto px-4">
        <article className="lg:w-1/2 flex pl-0 lg:pl-10 flex-col items-start mb-0 lg:mb-0">
          <header>
          ...
          <p className="text-lg text-left lg:text-xl leading-tight max-w-4xl mb-3">
            O FitPilot é a solução ideal para academias que desejam
          ...
          <p className="text-lg text-left lg:text-xl leading-tight max-w-4xl mb-12">
            ...
            confusões sobre qual aluno está com qual plano. O FitPilot resolve
        ...
        <figure className="lg:w-1/2 flex justify-center items-center mt-2 lg:mt-0">
          <Image
            src="/screens.png"
            alt="FitPilot"
            width={500}
