  ...
  return (
    <>
      ...
      <section className="min-h-[calc(90vh-120px)] lg:min-h-screen relative bg-cover bg-center bg-no-repeat text-white pt-20" id="home" style={{ backgroundImage: "url('/gym background.jpg')" }}>
        ...
        <div className="container flex flex-col items-center justify-center mx-auto text-left lg:text-center px-4 lg:px-12 min-h-[calc(95vh-150px)] relative">
          <h1 className="text-5xl md:text-center lg:text-6xl font-bold leading-tight mb-6 relative z-10">
            Bem-vindo ao <span className="text-[#00bb83]">FitFusion</span>!
          </h1>

          <p className="text-lg md:text-center lg:text-xl md:max-w-2xl mx-auto mb-8 relative z-1">
